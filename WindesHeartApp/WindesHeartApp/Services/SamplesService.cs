...
namespace WindesHeartApp.Services
{
    public class SamplesService
    {
        ...
        private void FillDatabase(List<ActivitySample> samples)
        {
            ...
            Globals.Database.Instance.BeginTransaction(); //remove
            ...
            Globals.Database.Instance.Commit(); //remove
        ...
        {
            var heartRate = new WindesHeartApp.Models.Heartrate(datetime, sample.HeartRate != 255 ? sample.HeartRate : -1);
        ...
        private IHeartrateRepository GetHeartRateRepository() {
            IHeartrateRepository heartrate = _heartrateRepository;
            return heartrate;
        }
    }
}
